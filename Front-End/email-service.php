                                ...
                                <table class="col-12">
                                    <tr>
                                        <td class="p-4 pt-2 col-12">
                                            <input style="padding-bottom: 80px;background-color: rgb(211,211,211, 0.3)" type="text" class="col-12 col-md-12 d-block input-obs" name="observaçoes" placeholder="Observações">
                                        </td>
                                    </tr>
                                </table>
                                <table class="offset-md-8 offset-lg-9 offset-xxl-10 col-xxl-2 table-button">
                                    <tr>
                                        <td>
