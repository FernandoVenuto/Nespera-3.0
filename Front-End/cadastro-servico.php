                                        ...
                                        <div class="col-xxl-12 col-lg-12">
                                            <div class="col-md-12 pt-5">
                                                ...
                                                <table class="col-md-12">
                                                    <tr>
                                                        <td class="col-12 col-xxl-4 col-md-4 p-4 pt-2 d-inline-block">
                                                            <label for="client-name" class="col-12  "> Cliente <span style="color: red">*</span>
                                                                <input type="text" class="col-12  col-md-11 d-block" placeholder="nome do cliente" name="client-name" required>
                                                            </label>
                                                        </td>
                                                        <td class="col-12 col-xxl-4 col-md-4 p-4 pt-2 d-inline-block">
                                                            <label for="agencia" class="col-12 "> Produto <span style="color: red">*</span>
                                                                <input type="text" class="col-12  col-md-11 d-block" name="agencia" placeholder="nome da agência" required>
                                                            </label>
                                                        </td>
                                                        <td class="col-12 col-xxl-4 col-md-4 p-4 pt-2 d-inline-block">
                                                            <label for="agencia" class="col-12 "> Serviço <span style="color: red">*</span>
                                                                <input type="text" class="col-12  col-md-11 d-block" name="agencia" placeholder="nome da agência" required>
                                                            </label>
                                                        </td>
                                                    </tr>
