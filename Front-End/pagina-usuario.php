            ...
            <div class="h-25  col-sm-10 col-md-10 col-lg-10 col-xxl-10 dashboard-bg">
                <div class="row">
                    <div class="col-9 col-md-10 pt-4 ">
                        <h1 style="color: #707070;" class="my-0">Usuários</h1>
                    </div>
                        ...
                        <div class="col-md-12 pt-3">
                            <div class="d-md-none d-block col-md-12 px-4">
                                <div class="exibir" style="font-size:14px;">
                                    <p class="my-1 d-inline me-4" style="color:#b2b1b6 ;">Exibir <input class="ex-number" type="number" name="exibir-user" style="max-width:45px;" min="1" max="20"> registros</p>
                                        ...
                                        <tr>
                                            <td class="px-4 pt-2 pb-2 col-12 col-md-3 d-inline-block">
                                                <label for="cliente" class="col-12"> Pesquisar
                                                    <input type="text" class="col-12 d-block" name="buscar-usuario" placeholder="pesquisar" required>
                                                </label>
                                            </td>
                                            <td class="col-4 d-md-none">
                                                <button type="button" id="button-config" class="button-env3" style="color:white!important; margin-top:39px;"><span id="button-config"><a href="cadastro-usuario.php" id="config-button"> Adicionar usuário</a> </span></button>
                                            </td>
                                        </tr>
                                    </table>
                                </form>
                            ...
                            <div class="d-none d-md-block col-md-12 px-4">
                                <div class="exibir" style="font-size:14px;">
                                    <p class="my-1 d-inline me-4" style="color:#b2b1b6 ;">Exibir <input class="ex-number" type="number" name="exibir-usuario" style="max-width:45px;" min="1" max="20"> registros</p>
                                    <p class="my-1 d-inline"><a href="#" style="color:#b2b1b6 !important;">Exportar </a><img src="imagens/export.webp" width="16" height="16"></p>
                                </div>
                            </div>
                            <div class="row g-0 d-none d-md-block">
                                <table class="col-12 offset-md-8 offset-lg-9 offset-xxl-10 col-xxl-2 ">
                                    <tr>
                                        <td>
                                            <button id="button-config" class="button-env3" style="color:white!important;"><span id="button-config"> <a href="cadastro-usuario.php" id="config-button">Adicionar usuário</a> </span></button>
                                        </td>
                                    </tr>
                                </table>
                            </div>
