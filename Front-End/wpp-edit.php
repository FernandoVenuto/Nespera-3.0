                    ...
                    <div class="dashboard-box">
                        ...
                        <div class="row g-0">
                            <div class=" col-12 col-md-9 pt-4">
                                ...
                                <div class="row g-0">
                                    <div class="px-3 col-12 col-md-7 pt-3">
                                        <input type="text" placeholder="Observações" class="p-3 col-12 col-md-12" style="background-color:#f6f6f6;">
                                    </div>
                                    <div class="col-1-img pt-5 text-center">
                                        <img src="imagens/del.webp" alt="" id="width-icon" style="cursor:pointer;">
                                    </div>
                                    <div class="col-1-img pt-5 text-center">
                                        <img src="imagens/edit.webp" alt="" id="width-icon" style="cursor:pointer;">
                                    </div>
                                    <div class="col-1-img pt-5 text-center">
                                        <img src="imagens/save.webp" alt="" id="width-icon" style="cursor:pointer;">
                                    </div>
                                </div>
                            </div>
