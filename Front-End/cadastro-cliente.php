                                        ...
                                        <div class="col-md-12 pt-5">
                                            <form action="">
                                                <table class="col-md-12">
                                                    ...
                                                    <tr>
                                                        <td class="col-12 col-xxl-4 col-md-6 p-4 pt-2 d-inline-block">
                                                            <label for="responsavel" class="col-12 "> Responsável <span style="color: red">*</span>
                                                                <input type="text" class="col-12  col-md-10 d-block" name="responsavel" placeholder="nome do responsável" required>
                                                            </label>
                                                        </td>
                                                        <td class="col-12 col-xxl-4 col-md-6 p-4 pt-2 d-inline-block">
                                                            <label for="nome" class="col-12 "> E-mail o reponsável <span style="color: red">*</span>
                                                                <input type="email" class="col-12  col-md-10 d-block" name="e-mail-responsavel" placeholder="e-mail do responsável" required>
                                                            </label>
                                                        </td>
                                                    </tr>
                                                </table>
