            ...
            <div class="h-25  col-sm-10 col-md-10 col-lg-10 col-xxl-10 dashboard-bg">
                <div class="row">
                    <div class="col-9 col-md-10 pt-4 ">
                        <h1 style="color: #707070;" class="my-0">Serviços</h1>
                    </div>
                        ...
                        <div class="col-md-12 pt-3">
                                    ...
                                    <table class="col-12 col-md-12">
                                        <tr>
                                            <td class="px-4 pt-2 pb-2 col-12 col-md-3 d-inline-block">
                                                <label for="buscar-servicos" class="col-12"> Pesquisar
                                                    <input type="text" class="col-12 d-block" name="buscar-servicos" placeholder="pesquisar" required>
                                                </label>
                                            </td>
                                            <td class="col-4 d-md-none">
                                                <button type="button" id="button-config" class="button-env3" style="color:white!important; margin-top:39px;"><span id="button-config"><a href="cadastro-servico.php" id="config-button"> Adicionar serviço</a> </span></button>
                                            </td>
                                        </tr>
                                    </table>
                                </form>
                            ...
                            <div class="row g-0 d-none d-md-block">
                                <table class="col-12 offset-md-8 offset-lg-9 offset-xxl-10 col-xxl-2 ">
                                    <tr>
                                        <td>
                                            <button id="button-config" class="button-env3" style="color:white!important;"><span id="button-config"> <a href="cadastro-servico.php" id="config-button">Adicionar serviço</a> </span></button>
                                        </td>
                                    </tr>
                                </table>
                            </div>
